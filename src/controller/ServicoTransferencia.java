...
public class ServicoTransferencia extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String pIdClienteDeb = request.getParameter("data[idCliente]");
		...
		try {
			if (pIdClienteDeb != null && !pIdClienteDeb.equals("")) {
				idClienteDeb = Integer.parseInt(pIdClienteDeb);
			}
		...
		cliente = new Cliente(idClienteDeb, "", -1, -1);
